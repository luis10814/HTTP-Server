...
a7-submit.tgz: $(SUBMIT_FILES)
	mkdir -p assignment7-submission
	cp $(SUBMIT_FILES) assignment7-submission
	tar cvzf $@ assignment7-submission

a6-handout.tgz: $(HANDOUT_FILES) assignment6.pdf
	pax -w -s '@^@assignment6/@' -z -f $@ assignment6.pdf $(HANDOUT_FILES) test-site t

a7-handout.tgz: $(HANDOUT_FILES) assignment7.pdf
	pax -w -s '@^@assignment7/@' -z -f $@ assignment7.pdf $(HANDOUT_FILES) test-site t
